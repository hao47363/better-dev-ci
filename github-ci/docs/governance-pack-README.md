...
| Understand org settings and tokens | [Centralized CI setup](./central-ci-setup.md) · [Consumer guide](../README.md) |
...
**More detail:** [Centralized CI setup](./central-ci-setup.md) · [CI and DevX flow](./operations/ci-devx-flow.md) · [Central tooling README](../README.md)
...
| Consumer-focused workflow examples | [Central tooling README](../README.md) |
